...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "Burst_ID_WIDTH" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "SLAVE_BASE_ADDR" -parent ${Page_0}


}

proc update_PARAM_VALUE.Burst_ID_WIDTH { PARAM_VALUE.Burst_ID_WIDTH } {
	# Procedure called to update Burst_ID_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.Burst_ID_WIDTH { PARAM_VALUE.Burst_ID_WIDTH } {
	# Procedure called to validate Burst_ID_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.Burst_ID_WIDTH { MODELPARAM_VALUE.Burst_ID_WIDTH PARAM_VALUE.Burst_ID_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.Burst_ID_WIDTH}] ${MODELPARAM_VALUE.Burst_ID_WIDTH}
}
